...
@ContextConfiguration(classes = {Scenario1Controller.class, ExceptionHandlerAdvice.class})
@AutoConfigureMockMvc(printOnlyOnFailure = false)
@ExtendWith(MockitoExtension.class)
@ImportAutoConfiguration(ExceptionHandlerAdvice.class)
public class Scenario1ControllerIntegrationTest {
    ...
    public void restCallWithHeaderXCountryWithValidValueLowercase() throws Exception {
        mockMvc.perform(get("/scenario1").header("X-Country", "ch")).andExpect(status().isOk());
    }
